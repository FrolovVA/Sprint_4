...
public class chromeBottomOrderButtonTest {
    ...
    public chromeBottomOrderButtonTest(String clientName, String clientSecondName, String clientAdress, String clientMetro, String clientPhoneNumber){
