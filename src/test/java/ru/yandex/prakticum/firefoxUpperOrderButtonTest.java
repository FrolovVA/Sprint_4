...
public class firefoxUpperOrderButtonTest {
    ...
    public firefoxUpperOrderButtonTest(String clientName, String clientSecondName, String clientAdress, String clientMetro, String clientPhoneNumber){
